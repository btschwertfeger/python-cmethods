...
# for file in `ls .github/workflows`; do sed -i '' 's/actions\/setup-python@v5/actions\/checkout@0a5c61591373683505ea898e09a3ea4f39ef2b9c  # v5.0.0/g' .github/workflows/$file; done
